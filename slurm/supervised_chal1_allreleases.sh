...
#!/bin/bash
#SBATCH --job-name=chal_1_${model_name}
#SBATCH --output=${EEGCHALLENGE_LOGS}/chal_1/long/chal_1_${model_name}_%a.out
#SBATCH --error=${EEGCHALLENGE_LOGS}/chal_1/long/chal_1_${model_name}_%a.err
#SBATCH --array=1
...
python "${EEGCHALLENGE_REPO}/pipelines/train_challenge1.py" \\
    --data_folder \${EEGCHALLENGE_DATA} \\
    --results_folder \${EEGCHALLENGE_RESULTS}/braindecode_long/challenge_1/\${SLURM_ARRAY_TASK_ID} \\
...
# ${window_length} - JSON input (2 sec), ${shift}
