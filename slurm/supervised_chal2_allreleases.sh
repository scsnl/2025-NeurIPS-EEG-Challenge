...
#!/bin/bash
#SBATCH --job-name=chal_2_${model_name}
#SBATCH --output=${EEGCHALLENGE_LOGS}/chal_2/all/chal_2_${model_name}_%a.out
#SBATCH --error=${EEGCHALLENGE_LOGS}/chal_2/all/chal_2_${model_name}_%a.err
#SBATCH --array=4
#SBATCH --time=24:00:00
#SBATCH --partition=gpu,owners,normal
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
...
python "${EEGCHALLENGE_REPO}/pipelines/train_challenge2.py" \\
    --data_folder \${EEGCHALLENGE_DATA} \\
    --results_folder \${EEGCHALLENGE_RESULTS}/braindecode_all/challenge_2/\${SLURM_ARRAY_TASK_ID} \\
    ...
    --cache_dataset \\
    --load_cached_dataset \\
    --cache_dir \${EEGCHALLENGE_DATA}/braindecode_cache/challenge_2/all \\
    --save_metrics \\
    --save_plots \\
    --save_model \\
    --num_workers 4 \\
