...
#!/bin/bash
#SBATCH --job-name=chal1_${model_name}
#SBATCH --output=${EEGCHALLENGE_LOGS}/chal_1/chal_1_${model_name}_%a.out
#SBATCH --error=${EEGCHALLENGE_LOGS}/chal_1/chal_1_${model_name}_%a.err
#SBATCH --array=1
...
python "${EEGCHALLENGE_REPO}/pipelines/train_challenge1.py" \\
    ...
    --results_folder \${EEGCHALLENGE_RESULTS}/braindecode/challenge_1/aug \\
